...
fun SignUpScreen(
    ...
    Box(modifier = Modifier
        ...
        Column(
            ...
            Text(
                text = "Enter your personal data to register",
            ...
            TextField(
                leadingIcon = { Icon(tint = GreenSuperDark,imageVector = Icons.Default.Face, contentDescription = "emailIcon") },
                value = userName,
                ...
                singleLine = true,
                placeholder = {
                    Text(text = "Username",color = GreenSuperDark)
                }
            )
            Divider(
